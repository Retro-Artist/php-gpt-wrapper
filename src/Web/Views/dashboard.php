                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?= htmlspecialchars($tool) ?></p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400"><?= $usage ?> agent<?= $usage > 1 ? 's' : '' ?></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-xs font-medium text-gray-600 dark:text-gray-400"><?= round($percentage) ?>%</span>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
