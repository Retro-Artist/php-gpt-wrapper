...
>
    ...
    >
        <template x-for="toast in toasts" :key="toast.id">
            <div 
                ...
                class="max-w-sm w-full bg-white shadow-theme-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden dark:bg-gray-800"
            >
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-shrink-0 flex">
                            <button 
                                ...
                                class="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800"
                            >
    ...
    <script>
        ...
        window.setLoading = function(loading) {
            const event = new CustomEvent('set-loading', { detail: { loading } });
