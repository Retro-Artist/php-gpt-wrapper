...
<body
              ...
              <ul class="space-y-1">
                <li>
                  <div class="flex items-center rounded-lg px-3 py-2 text-sm">
                    <div
                      class="mr-3 h-8 w-8 rounded-full bg-brand-100 dark:bg-brand-900 flex items-center justify-center">
                      <svg
  ...
  <div
    ...
    <div class="flex flex-col items-center gap-4">
      <div
        class="w-12 h-12 border-4 border-brand-200 border-t-brand-500 rounded-full animate-spin dark:border-gray-700 dark:border-t-brand-400"></div>
        ...
        <div class="p-4">
          <div class="flex items-start">
            ...
            <div class="ml-3 w-0 flex-1">
              <p
                class="text-sm font-medium text-gray-900 dark:text-white leading-5"
  ...
  <div id="confirm-modal" class="hidden fixed inset-0 bg-gray-900/50 backdrop-blur-sm z-[60]">
    <div
      class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-theme-xl">
      <div class="p-6">
  ...
  <script>
    ...
    window.showConfirmDelete = function(itemName, details = "This action cannot be undone.") {
      document.getElementById(
        "confirm-message"
      ).textContent = `Are you sure you want to delete "${itemName}"?`;
