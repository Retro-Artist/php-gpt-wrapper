...
>
    ...
    <!-- Hero Section -->
    <section class="relative overflow-hidden bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <!-- Background Pattern -->
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div class="text-center">
                <!-- Hero Badge -->
                <div class="inline-flex items-center rounded-full bg-brand-100 px-3 py-1 text-sm font-medium text-brand-800 ring-1 ring-inset ring-brand-200 dark:bg-brand-900/20 dark:text-brand-300 dark:ring-brand-800 mb-8">
                ...
                <div class="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3 lg:grid-cols-3">
                    <div class="flex flex-col items-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 text-center">Create custom AI agents with specialized tools</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Powerful Tools</h3>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 text-center">Math, search, weather, and file processing</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Real-time Chat</h3>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400 text-center">Instant responses with conversation history</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-base text-brand-600 font-semibold tracking-wide uppercase dark:text-brand-400">Features</h2>
                <p class="mt-2 text-3xl leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 xl:gap-16">
                ...
                <div class="flex gap-6">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Dynamic Agent Creation</h3>
                ...
                <div class="flex gap-6">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Extensible Tool System</h3>
                        <p class="mt-2 text-base text-gray-600 dark:text-gray-400">
                ...
                <div class="flex gap-6">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Clean Architecture</h3>
                        <p class="mt-2 text-base text-gray-600 dark:text-gray-400">
                ...
                <div class="flex gap-6">
                    <div class="flex-shrink-0">
                        <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100 dark:bg-orange-900/20">
    ...
    <section class="py-24 bg-gray-50 dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-md mx-auto bg-white dark:bg-gray-900 rounded-2xl shadow-theme-lg p-8 border border-gray-200 dark:border-gray-700">
                <div class="text-center">
